...
"""
    init_Suspension(compressions::Tuple{Any,Any}, 
                            # lower_wishbone
                            lower_bearing_front::Vector{Any},
                            lower_distance_to_joint_y::Any,
                            lower_distance_rotation_axis_to_lower_damper_fixture::Any,
                            lower_distance_to_joint_x::Any,
                            # upper_wishbone
                            upper_bearing_rear::Vector{Any},
                            upper_bearing_front::Vector{Any},
                            upper_distance_to_joint_y::Any,
                            upper_distance_to_joint_x::Any,
                            # dumper
                            damper_nominal_length::Any,
                            damper_travel::Any,
                            damper_upper_fixture::Any
    )

TBW
"""
function init_Suspension(compressions::Tuple{Any,Any}, 
                            # lower_wishbone
                            lower_bearing_front::Vector{Any},
                            lower_distance_to_joint_y::Any,
                            lower_distance_rotation_axis_to_lower_damper_fixture::Any,
    ...
    suspension = Suspension(compressions)

    suspension.lowerwishbone.bearing_front = lower_bearing_front
    suspension.lowerwishbone.distance_to_joint_y = lower_distance_to_joint_y
    suspension.lowerwishbone.distance_rotation_axis_to_lower_damper_fixture = lower_distance_rotation_axis_to_lower_damper_fixture
    suspension.lowerwishbone.distance_to_joint_x = lower_distance_to_joint_x


    suspension.upperwishbone.bearing_rear = upper_bearing_rear
    suspension.upperwishbone.bearing_front = upper_bearing_front
    suspension.upperwishbone.distance_to_joint_y = upper_distance_to_joint_y
    suspension.upperwishbone.distance_to_joint_x = upper_distance_to_joint_x

    suspension.damper.nominal_length = damper_nominal_length
    suspension.damper.travel = damper_travel
    suspension.damper.upper_fixture = damper_upper_fixture

...
"""
    tie_rod_rotational_component_angle_sweep(varphi_limits_deg, steering, suspension; side = :Left, ...)
...
is used by default.
"""
function tie_rod_rotational_component_angle_sweep(varphi_limits_deg,
                                         steering,
                                         suspension;
                                         side = :Left,

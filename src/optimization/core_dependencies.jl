"""
    outer_sigularity_constraint(angleConfig::Tuple{T,T},steering::Steering, suspension::Suspension)
...
"""
    inner_sigularity_constraint(angleConfig::Tuple{T,T},steering::Steering, suspension::Suspension)
...
"""
    left_circsphere_plane_dependence(angleConfig::Tuple{T,T},steering::Steering, suspension::Suspension)
...
"""
    right_circsphere_plane_dependence(angleConfig::Tuple{T,T},steering::Steering, suspension::Suspension)
...
"""
    left_circcirc_min_intersec_dependence(angleConfig::Tuple{T,T},steering::Steering, suspension::Suspension)
...
"""
    left_circcirc_max_intersec_dependence(angleConfig::Tuple{T,T}, steering::Steering, suspension::Suspension)
...
"""
    track_circle_dependence(angleConfig::Tuple{T,T}, steering::Steering, suspension::Suspension, measurments::Measurements)

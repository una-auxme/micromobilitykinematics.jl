...
![Figure 3.14: Projection of the main points of the scenario onto the y-z plane](../assets/Projection_of_the_main_points_of_the_scenario_onto_the_y_z_plane.png)